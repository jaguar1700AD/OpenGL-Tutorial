...
int main()
{
    ...
    Shader ourShader("src/vertex_shader.glsl", "src/fragment_shader.glsl");
    ...
    unsigned int texture1; glGenTextures(1, &texture1);
    ...
    unsigned int texture2; glGenTextures(1, &texture2);
